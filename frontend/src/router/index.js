...
import WritePlanView from "@/views/course/WritePlanView.vue";
import LoginView from "@/views/user/LoginView.vue";
import SignupView from "@/views/user/SignupView.vue";
import PlanDetailView from "@/views/course/PlanDetailView.vue";
import FreePostListView from "@/views/free/FreePostListView.vue";
import HomeView from "@/views/HomeView.vue";
import MypageView from "@/views/user/MypageView.vue";
import PlanListView from "@/views/course/PlanListView.vue";
...
import EditPlanView from "@/views/course/EditPlanView.vue";
